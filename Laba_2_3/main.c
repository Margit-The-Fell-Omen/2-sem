...
{ 
    ...
    int function_choice = 1;                                                                                            // выбор функци вывода
    ...
    while (flag)                                                                                                    // главный цикл программы
    {
        ...
        else if (struct_choise == 2) 
        {
            ...
            input_students_with_families_names(students, number_of_students, family_choise);      // функция ввода ФИО студентов с семьёй
            while (function_choice != 4)
            {
                input_int_var(&function_choice, 4, 0, 3);																		// выбор функции вывода       
